...
max_retries = 5
opt_threshold = 0.03
ignore_rules_below_threshold = 0.06
immediate_retry_threshold = 0.07
only_consider_anos = True
plateu_threshold = -1
check_every_n_iter = 25000
start_learning_rate = 0.001
print_every_n_iters = 500
retry_after_n_iters = 25000
draw_images = True
...
create_latent_space_dataset(root_dir=data_root_directory,
                            ...
                            num_color_channels=num_color_channels,
                            device=device,
                            n_latent_space_search_iterations=max_opt_iterations,
                            generator=mvtec_128_generator,
                            discriminator=mvtec_128_discriminator,
