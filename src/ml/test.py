...
base_path = '../data/DS4_mnist_9_9-lined_10_percent'
generator_path = os.path.join(base_path, 'generator.pkl')
matrix_a_path = os.path.join(base_path,
                             'direction_matrices/direction_matrix_steps_2500_bias_k_10.pkl')  # '../data/DS3_mnist_9_6_10_percent/direction_matrices/direction_matrix_steps_1000_bias_k_20.pkl'
z_dim = 100
...
matrix_a_linear: MatrixALinear = MatrixALinear(input_dim=10, output_dim=100, bias=True)
