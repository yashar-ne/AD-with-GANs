...
from src.ml.validation import load_latent_space_data_points_ano_class, get_lof_roc_auc_for_given_dims, \
...
latent_space_data_points, latent_space_data_labels = load_latent_space_data_points_ano_class(
...
result = get_roc_auc_for_average_distance_metric(direction_matrix=matrix_a_linear, anomalous_directions=[(1, 1), (2, 1)])
print(result)
